        ...
        {teachers.length > 0 && (
          <div className="mb-8 bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl p-6 border border-gray-200">
            <label className="block text-sm font-semibold text-gray-700 mb-3">
              <span role="img" aria-label="Axtarış">
                🔍
              </span>{" "}
          ...
          <div className="mb-8 bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 p-6 rounded-lg shadow-md">
            <div className="flex items-start">
              <div className="flex-shrink-0">
                <span className="text-2xl" role="img" aria-label="Məlumat">
                  ℹ️
                </span>
              </div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-2 mb-5">
                    <div className="flex items-center text-sm text-gray-700">
                      <span className="mr-2" role="img" aria-label="Kitab">
                        📚
                      </span>
                      <span className="font-medium">{exam.subject}</span>
                    </div>
                    <div className="flex items-center text-sm text-gray-700">
                      <span className="mr-2" role="img" aria-label="Vaxt">
                        ⏱️
                      </span>
                    ...
                    {exam.teacher && (
                      <div className="flex items-center text-sm text-gray-700">
                        <span className="mr-2" role="img" aria-label="Müəllim">
                          👤
                        </span>
                        <span className="font-medium">
